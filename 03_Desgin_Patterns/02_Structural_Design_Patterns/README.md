...
|---|---------------|------------------------|----------------|
| 1 | **Adapter Pattern** | Allows incompatible classes to work together by acting as a bridge. | দুইটি অমিল ক্লাসকে একসাথে কাজ করাতে “মধ্যস্থ” হিসেবে কাজ করে। |
| 2 | **Bridge Pattern** | Separates abstraction from implementation so they can vary independently. | abstraction ও implementation আলাদা করে দেয়, যাতে উভয়টি আলাদাভাবে পরিবর্তন করা যায়। |
| 3 | **Composite Pattern** | Composes objects into tree structures to represent part-whole hierarchies. | অবজেক্টগুলোকে গাছের মতো কাঠামোয় সাজায়, যেমন ফোল্ডার ও সাবফোল্ডার। |
| 4 | **Decorator Pattern** | Adds new behavior to objects dynamically without altering existing code. | পুরনো ক্লাস পরিবর্তন না করেই নতুন ফিচার যোগ করা যায়। |
| 5 | **Facade Pattern** | Provides a simple interface to a complex subsystem. | জটিল সিস্টেমের জন্য একটি সহজ ইন্টারফেস দেয়। |
